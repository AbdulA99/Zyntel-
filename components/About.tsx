...
const About: React.FC = () => {
  ...
  return (
    <section className="flex items-center mx-auto justify-center bg-white text-black py-20 xl:py-20" id="about">
      <div className="container mx-auto flex flex-col lg:flex-row justify-center px-4 lg:px-8">
        <div className="relative w-full lg:w-1/2 flex justify-center lg:justify-end mb-8 lg:mb-0">
          <motion.div
            ref={ref1}
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left py-8">
          ...
          <div className="flex flex-col md:flex-row justify-center lg:justify-start gap-4">
            <button className="bg-indigo-600 text-white py-2 px-4 rounded hover:bg-gray-800 transition duration-150">
              Explore Details
            </button>
            <button className="bg-white text-black border rounded-md py-2 px-4 hover:bg-gray-100 transition duration-150">
              Learn More
            </button>
          </div>
        </div>
