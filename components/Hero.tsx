...
const stats = [
  {
    label: "Number Of Successful Candidates",
    value: 231,
    ...
    <div className="relative">
      ...
      <div className="relative max-w-screen-xl mx-auto flex flex-col md:flex-row justify-between items-center px-4 md:px-8">
        {stats.map((stat, index) => (
          <div
            key={index}
            className="text-center mb-8 md:mb-0 w-full sm:w-1/2 md:w-1/3 px-4"
          >
            ...
            <div className="flex items-baseline justify-center">
              <span
                className="text-xl md:text-2xl font-bold text-black dark:text-white mr-2"
                ref={useCountUp(stat.value)}
              >
                0
              </span>
  ...
  return (
    <section className="py-20 mt-14 bg-white dark:bg-gray-900" id="hero">
      <div className="max-w-screen-xl mx-auto text-gray-600 dark:text-gray-300 gap-x-12 flex flex-col md:flex-row items-center justify-between px-4 md:px-8">
        <div className="flex-none space-y-5 lg:max-w-xl w-full">
          <h1 className="text-sm text-indigo-600 dark:text-indigo-400 font-medium text-[22px] xl:text-[20px]">
            We Are #1 On The Market.
          </h1>
          <h2 className="xl:text-[48px] text-3xl sm:text-4xl text-gray-800 dark:text-gray-100 font-extrabold md:text-5xl lg:text-6xl 2xl:text-6xl">
            Bridging Talents{" "}
            <span className="text-indigo-600 dark:text-indigo-400">&</span>{" "}
            Building Futures.
          </h2>
          <p className="lg:text-[18px] xl:text-[18px] text-base sm:text-lg 2xl:text-xl">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3">
            <a
              href="#"
              className="block py-2 px-4 text-center text-white font-medium bg-indigo-600 dark:bg-indigo-500 duration-150 hover:bg-indigo-500 dark:hover:bg-indigo-400 active:bg-indigo-700 rounded-lg shadow-lg hover:shadow-none 2xl:py-3 2xl:px-5"
            >
              Contact Us
            </a>
            <a
              href="#"
              className="flex items-center justify-center gap-x-2 py-2 px-4 text-gray-700 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-400 font-medium duration-150 active:bg-gray-100 dark:active:bg-gray-700 border rounded-lg md:inline-flex 2xl:py-3 2xl:px-5"
            >
              Learn More
              <svg
        ...
        <div className="flex-none mt-14 md:mt-0 md:max-w-xl xl:max-w-xl w-full">
          <Image
            src={HeroImage}
            className="md:rounded-tl-[108px] w-full h-auto"
            alt="Hero"
          />
        </div>
      </div>
